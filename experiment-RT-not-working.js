...
var informed_consent = {
  ...
  choices: [" "], // only proceed when the spacebar is pressed
...
var practice_trial_timed = {
  ...
  questions: [
    { prompt: jsPsych.timelineVariable("target_word"), name: "practice_trial" },
  ],
...
var timeline_practice_timed = {
  ...
  timeline_variables: [
    { target_word: "car", trial_timer: 10000 },
    { target_word: "bike", trial_timer: 5000 },
    { target_word: "balloon", trial_timer: 7500 },
  ],
...
var instruction_accuracy = {
  ...
  stimulus:
    ...
    "Typing real words" +
    "<li>" +
    "<b>No</b> keyboard bashing (asdahsiudaisdya)" +
    "<li>" +
    "Preventing repeated answers" +
    "</ul>" +
